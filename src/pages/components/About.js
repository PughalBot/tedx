...
const About = () => {
  return (
    ...
    >
      <h1 className="font-te text-3xl md:text-7xl pl-4 md:pl-10 text-[#db1068]">About TEDx</h1>
      <div className="grid grid-cols-1 gap-6 md:gap-6 pb-6 px-4 md:pl-10 md:pr-10">
      ...
      <h1 className="font-te text-3xl md:text-7xl pl-4 md:pl-10 text-[#db1068]">About TEDxSriSairamEngineeringCollege</h1>
      <div className="grid grid-cols-1 gap-6 md:gap-10 pb-6 px-4 md:pl-10 md:pr-10">
      ...
      <h1 className="font-te text-3xl md:text-7xl pl-4 md:pl-10 text-[#db1068]">Our Theme - "Shaping the Future"</h1>
      <div className="grid grid-cols-1 gap-6 md:gap-10 pb-6 px-4 md:pl-10 md:pr-10">
        <p className="text-justify md:text-2xl font-js text-white">The theme for our TEDx Event is "Shaping the Future." We chose this theme because we firmly believe that the future is not a predetermined path but a canvas upon which we can all leave our mark. It is a theme that invites us to explore the limitless potential that exists within each of us to actively shape the world around us.</p>
