...
const About = () => {
  return (
    ...
    >
      <h1 className="font-te text-3xl md:text-5xl pl-4 md:pl-10 text-[#db1068]">About TEDx</h1>
      ...
      <h1 className="font-te text-3xl md:text-5xl pl-4 md:pl-10 text-[#db1068]">About TEDxSriSairamEngineeringCollege</h1>
      ...
      <h1 className="font-te text-3xl md:text-5xl pl-4 md:pl-10 text-[#db1068]">Our Theme - "Shaping the Future"</h1>
      <div className="grid grid-cols-1 gap-6 md:gap-10 pb-6 px-4 md:pl-10 md:pr-10">
