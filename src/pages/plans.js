    ...
    <div className="min-h-screen flex items-center justify-center bg-[#2c1262]">
      <div className="p-8 space-y-8 bg-white shadow-lg rounded-lg">
        ...
        <Link href="https://forms.gle/DoEuQbXLdXLLtGY49">
          ...
          >
            <h2 className="text-xl font-bold text-center mb-4">Premium Pass - <span className='text-sm font-semibold'>₹735</span></h2>
            ...
            <p className='text-sm md:text-md text-center font-bold  mt-4 mb-4'>49 of 100</p>
          </motion.div>
          </Link>
          ...
          <Link href="https://forms.gle/DUudNUcKXWVAkMGh8">
            ...
            >
                <h2 className="text-xl font-bold text-center mb-4">Standard Pass - <span className='text-sm font-semibold'>₹615</span></h2>
                ...
                <p className='text-sm md:text-md text-center font-bold mt-4 mb-1'>67 of 350</p>
